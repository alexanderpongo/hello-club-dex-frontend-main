  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        selected:
          'bg-primary/50 text-dark hover:bg-primary/50 hover:text-dark focus:bg-primary/50 focus:text-dark rounded-l-md rounded-r-md',
        today: 'text-primary',
        outside:
          ...
          return (
            <div className="inline-flex gap-2">
              ...
              >
                ...
                <SelectContent className="card-primary">
                  {MONTHS.map((month) => (
                    <SelectItem
                      key={month.value}
    ...
    return (
      <div className="flex h-10 items-center">
        ...
        >
          ...
          <SelectContent className='card-primary'>
            <SelectItem className="cursor-pointer hover:bg-white/20" value="AM">
              AM
            </SelectItem>
            <SelectItem className="cursor-pointer hover:bg-white/20" value="PM">
              PM
            </SelectItem>
          </SelectContent>
        </Select>
  ...
  (
    ...
    return (
      <Input
        ...
        name={name || picker}
        className={cn(
          'w-[48px] text-center font-mono text-base tabular-nums caret-transparent focus:bg-dark focus:text-primary [&::-webkit-inner-spin-button]:appearance-none cursor-pointer',
          className
        )}
  ...
  (
    ...
    return (
      <Popover>
        ...
        <PopoverContent className="w-auto p-0 card-primary">
          <Calendar
            mode="single"
