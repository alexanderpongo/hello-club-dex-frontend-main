...
import SlippageSettingDialog from "@/components/evm/SlippageSettingDialog";
import { useSwapStore } from "@/store/useDexStore";
import { TradeTokenType } from "@/interfaces/index.i";
import { useAccount } from "wagmi";
import { formatUnits, parseUnits } from "viem";
import TradeFromTokenDetails from "@/components/trading-live-inner/TradeFromTokenDetails";
import { AlertTriangle, ArrowDownUp } from "lucide-react";
import TradeToTokenDetails from "@/components/trading-live-inner/TradeToTokenDetails";
import SwitchNetworkButton from "@/components/trading-live-inner/SwitchNetworkButton";
import TradeSwapButton from "@/components/trading-live-inner/TradeSwapButton";

interface SwapModelProps {
  poolData: SinglePoolData;
  liquidityAmount: number | null;
}

const SwapModel: React.FC<SwapModelProps> = (props) => {
  const { poolData, liquidityAmount } = props;
  ...
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-[425px] p-0 border-none">
        ...
        <Card className="w-full card-primary rounded-xl  flex flex-col border dark:border-[#ffffff] dark:border-opacity-10 items-center justify-center p-5 space-y-3 pt-8">
          <div className="flex  justify-between items-center w-full">
            <div className="text-primary text-[18px] font-formula leading-7 font-light uppercase">
              Trade
            </div>
            <div>
                ...
                <div className="space-y-4 w-full">
                  <div className="flex w-full flex-col gap-2 items-center">
                    ...
                    <div
                      ...
                      onClick={
                        isWrongNetwork ? undefined : handleSwapTokenDetails
                      }
                    >
