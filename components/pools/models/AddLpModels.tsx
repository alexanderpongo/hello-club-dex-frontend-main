...
import { BasePriceObj } from "@/components/pools/pools-positions/PoolPositionInnerView";
...
interface AddLpModelsProps {
  poolData: SinglePoolData;
  basePrice: BasePriceObj | null;
}

const AddLpModels: React.FC<AddLpModelsProps> = (props) => {
  ...
  return (
    <Dialog>
      <DialogTrigger asChild>
        <Button
          variant={"default"}
          className="button-primary  dark:text-black font-lato font-semibold sm:text-sm sm:px-4 sm:h-9  text-xs sm:py-2 py-1 px-2 rounded-full "
        >
          <Plus /> ADD LIQUIDITY
        </Button>
      </DialogTrigger>
      <DialogContent className="sm:max-w-[425px] p-0 border-none">
        ...
        <Card className="w-full card-primary rounded-xl flex flex-col items-center justify-center p-5 space-y-3 pt-8">
          <>
            ...
            <div className="flex flex-col w-full">
              ...
              <div className="flex flex-col w-full ">
                ...
                <TradingLiquidityRangeSelector
                  feeTier={poolData.fee_tier_raw}
                />
                ...
                <div className="flex flex-col w-full pt-1">
                  ...
                  <div className="pt-3 mt-4">
                    {isWrongNetwork ? (
                      ...
                      <TradeAddLPButton poolData={poolData as any} />
                    )}
                  </div>
                </div>
              </div>
