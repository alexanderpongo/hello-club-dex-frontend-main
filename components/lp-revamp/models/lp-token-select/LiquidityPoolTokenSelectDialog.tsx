...
interface LiquidityPoolTokenSelectDialogProps {
...
const LiquidityPoolTokenSelectDialog: React.FC<
  LiquidityPoolTokenSelectDialogProps
> = (props) => {
...
export default LiquidityPoolTokenSelectDialog;
